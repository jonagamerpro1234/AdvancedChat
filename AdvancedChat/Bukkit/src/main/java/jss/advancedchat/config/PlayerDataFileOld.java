...
public class PlayerDataFileOld extends FileManager implements IFileHelper, IFolderHelper {
	...
	public PlayerDataFileOld(AdvancedChat plugin, String path, String folderpath) {
		super(plugin);
		this.plugin = plugin;
		this.path = path;
